...
public class InvestigacionFragment extends Fragment {
    ...
    public void onResume() {
        ...
        adapter = new FragmentPagerItemAdapter(
                ...
                .add(FragmentPagerItem.of("Inicio", FacultadInicioFragment.class, new Bundler().putString("id", "12/4").get()))    //  2 es el maximo de noticias
                ...
                .add(FragmentPagerItem.of("Líneas", WebViewFragment.class, WebViewFragment.arguments(ip+Constants.WS_INVESTIGACION_LINEAS)))
                .add(FragmentPagerItem.of("Proyectos", WebViewFragment.class, WebViewFragment.arguments(ip+Constants.WS_INVESTIGACION_PROYECTOS)))
                .add(FragmentPagerItem.of("Investigadores", WebViewFragment.class, WebViewFragment.arguments(ip+Constants.WS_INVESTIGACION_INVESTIGADORES)))
                .create());
